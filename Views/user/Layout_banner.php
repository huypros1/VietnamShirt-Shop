<!-- Banner Carousel -->
        ...
        <div id="mainCarousel" class="carousel slide" data-bs-ride="carousel">  
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="Public/image/z7334211923730_22a4319f4084266ae72414426ae82996.jpg" class="d-block w-100 h-100 banner-img" alt="Banner Thu Đông">
                </div>
            </div>
        </div>
    </section>
    ...
    <!-- Features -->
    <section class="service-section py-4 bg-light">
    <div class="container">
        <div class="row g-4 text-center">
            ...
            <div class="col-md-3 col-6">
                <div class="service-item">
                    <i class="fas fa-sync-alt fa-2x text-danger mb-3"></i>
            ...
            <div class="col-md-3 col-6">
                <div class="service-item">
                    ...
                    <h6 class="fw-bold">Thanh toán bảo mật</h6>
                    <p class="small text-muted mb-0">An toàn tuyệt đối 100%</p>
                </div>
            </div>
            <div class="col-md-3 col-6">
                <div class="service-item">
